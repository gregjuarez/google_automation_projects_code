...
def process_data(data):
  ...
  for item in data:
    ...
    if item["car"]["car_year"] not in car_yr_count:
      car_yr_count[item["car"]["car_year"]] = 0
      car_yr_count[item["car"]["car_year"]] += item["total_sales"]
    else:
      car_yr_count[item["car"]["car_year"]] += item["total_sales"]
  best_year, best_year_sales = max(car_yr_count.items(), key = lambda x:x[1])
  summary = [
